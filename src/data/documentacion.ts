...
export const REQUISITOS_FUNCIONALES: Modulo[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'RF-208', titulo: 'Presentaciones (slides) para cliente', descripcion: 'Creación de presentaciones ligadas a un proyecto con control remoto de avance de diapositivas en tiempo real.', prioridad: 'baja', estado: 'implementado', origen: 'src/pages/admin/slides, presentations', verificacion: 'Prueba manual con dos pestañas: control del administrador y vista del cliente, confirmando sincronización.', notas: 'Sincronización por polling corto sobre HTTP, no WebSockets; suficiente para el caso de uso pero con latencia de hasta un ciclo de polling.', relacionados: ['CU-16'] },
    ],
  },
  {
    id: 'finanzas',
