...
export const REQUISITOS_FUNCIONALES: Modulo[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'RF-809', titulo: 'Portal de demostración', descripcion: 'Un tenant marcado como demo permite recorrer el portal sin ser cliente, con re-siembra automática por cron.', prioridad: 'baja', estado: 'implementado', origen: 'src/pages/api/portal/demo.ts, src/pages/api/cron/portal-demo-reseed.ts', verificacion: 'tests/portal-demo.test.ts.', relacionados: ['RF-008'] },
