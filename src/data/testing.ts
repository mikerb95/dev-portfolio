...
export const NIVELES: Nivel[] = [
  {
    ...
    volumen: `${EJECUCION.niveles.unitarias.pruebas} tests sobre funciones sin efectos`,
    archivos: `tests/*.test.ts (${EJECUCION.niveles.unitarias.archivos} archivos)`,
    cuando: 'push',
    bloquea: true,
  ...
  },
  {
    ...
    volumen: `${EJECUCION.niveles.integracion.pruebas} tests contra una base de verdad`,
    archivos: `${EJECUCION.niveles.integracion.archivos} archivos: payments, cobros-db, portal-*, security-blocklist-db`,
    cuando: 'push',
    bloquea: true,
  ...
  },
  {
    id: 'carga',
    n: 15,
    nombre: 'Pruebas de carga y estrés',
    herramienta: 'k6',
    pregunta: '¿Cuántos usuarios sostiene el sistema en condiciones normales, y a qué ritmo colapsa cuando se lo aprieta?',
    volumen: 'lab/k6/carga.js (escalera 10-1000 VUs) y lab/k6/estres.js (quiebre por ramping-arrival-rate + recuperación por tramos de 15 s + CPU/heap del proceso), corridas locales',
    archivos: 'lab/k6/carga.js, lab/k6/estres.js, lab/k6/lib/perfil.js, src/pages/api/lab/proceso.ts',
    cuando: 'manual',
    bloquea: false,
    puntoCiego: 'Corre local contra npm run dev:carga, nunca contra producción (Vercel factura por invocación y Turso tiene cuota de filas). Falta integrarlo al panel (tabla load_test_runs, /admin/lab/load) y a CI: eso sigue bloqueado por no tener un preview/staging estable (VERCEL_TOKEN).',
    acento: 'ember',
    pendiente: true,
  },
]
