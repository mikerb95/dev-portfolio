...
export const NIVELES: Nivel[] = [
  {
    ...
    volumen: '~430 tests sobre funciones sin efectos',
    archivos: 'tests/*.test.ts (38 archivos)',
    cuando: 'push',
    bloquea: true,
  ...
  },
  {
    ...
    volumen: '8 monitores, sondeo cada ~5 min',
...
export const PIPELINE: EtapaPipeline[] = [
  ...
  },
  {
    ...
    duracion: 'continuo',
    pasos: [
      '8 monitores sondean endpoints públicos y alimentan /status',
