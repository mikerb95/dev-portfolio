    ...
    historias: [
      {
        ...
        dod: [
          ...
          ok('La calculadora en /ep exporta los hitos a .ics para importarlos al calendario del aprendiz y genera un enlace compartible con los parámetros en la URL. Cada evento lleva VALARM a 7 y 1 día: el recordatorio lo dispara el calendario del propio aprendiz, sin pedirle el correo ni guardar nada de un visitante.'),
          ok('src/lib/festivos-co.ts (módulo puro) calcula los 18 festivos colombianos del año - fijos, los que la Ley 51 de 1983 corre al lunes, y los móviles respecto al Domingo de Pascua por el algoritmo gregoriano anónimo - y marca los hitos que caen en fin de semana o festivo proponiendo el último día hábil. Cubierto por tests/festivos-co.test.ts contra fechas conocidas de Pascua y traslados Emiliani.'),
          ok('La página tiene hoja de impresión propia (@media print, is:global porque alcanza navbar y footer): oculta cromo, barra lateral y formularios, fuerza la paleta a tinta sobre papel y deja los checkbox de entrega vacíos para marcar a mano. El botón Imprimir / PDF existía desde antes sin estilos de impresión.'),
          ok('Un botón "Crear mi cronograma" lleva al formulario y deja el foco en la fecha. La ficha de la página sigue siendo la de referencia: el cronograma de otro aprendiz se calcula, no reemplaza el contenido por defecto.'),
