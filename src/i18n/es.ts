...
const es = {
  ...
  home: {
    ...
    bento: {
      ...
      location: {
        badge: 'Base',
        country: 'Colombia',
        tz: 'GMT−5 · Remoto global',
        hora: 'hora local',
        coords: '4,71° N · 74,07° O · Bogotá',
      },
      contactMicro: {
        badge: 'Inbound',
  ...
  engineering: {
    ...
    instrumento: {
      titulo: 'Tu visita',
      sub: 'medida en tu navegador',
      midiendo: 'midiendo…',
      listo: 'repetición de tu carga',
      repetir: 'Clic en la pantalla para repetir',
      sinJs: 'Tu navegador mide esta visita mientras carga. Con JavaScript activo, aquí verías su traza.',
      fases: { red: 'red', servidor: 'servidor', descarga: 'descarga', render: 'pintado' },
      recursos: '{n} recursos · {kb} kB',
      lectura: '{t} · {fase} · {kb} kB recibidos',
      masRapida: 'más rápida que el {pct} % de las visitas',
      p75Real: 'p75 de visitas reales: {value}',
      tu: 'tú',
      sinMuestras: 'aún sin visitas reales con las que comparar',
      inpPedir: 'Haz clic o toca cualquier parte de la página para medir tu INP.',
      inpListo: 'INP de tu última interacción: {value} ({rating}).',
      cls: 'Estabilidad visual (CLS) de esta visita: {value}.',
      privacidad: 'Se calcula en tu navegador y no envía nada nuevo: son las mismas métricas anónimas que el sitio ya recoge.',
      frente: 'frente a {n} visitas reales · {days} días',
    },
    secciones: {
      vitals: {
        label: 'Web Vitals reales',
        titulo: 'Cinco medidores, llenos con visitas reales.',
        sub: 'Cada barra es un grupo de visitas; la aguja es el p75, el valor con el que Google clasifica un sitio. El punto marcado es tu visita.',
      },
      pipeline: {
        label: 'Pipeline CI/CD',
        titulo: 'Del commit a producción, con red de seguridad.',
        sub: 'Así llegó a producción el último cambio: con cada etapa en verde y comprobado después del despliegue.',
      },
      uptime: {
        label: 'Disponibilidad',
        titulo: 'Noventa días, un día por barra.',
        sub: 'Cada barra es el porcentaje de sondeos exitosos de ese día. Los días sin datos se dejan como hueco, a la vista.',
      },
      verify: { label: 'Fuentes' },
    },
    vitals: {
    ...
    pipeline: {
      ...
      etapas: {
        ...
        tests: 'Tests y build',
        deploy: 'Despliegue',
        health: 'Verificación en producción',
    ...
    uptime: {
      ...
      mttr: 'MTTR {n} min',
      tiraLectura: '{day} · {pct} · {n} sondeos',
      tiraHueco: '{day} · sin datos',
      tiraDesde: 'hace 90 días',
      tiraHoy: 'hoy',
      presupuesto: 'equivale a {time} sin servicio en 90 días',
    },
    verifiable: {
  ...
  tools: {
    ...
    // Textos del motion de la página: el circuito del hero y las escenas de la
    // ventana de los casos. Los datos de las maquetas (dominios, versiones,
    // montos, rutas) viven en los componentes, no aquí.
    motion: {
      circuito: {
        etiqueta: 'Circuito de operación: por dónde pasa cada herramienta cuando algo ocurre',
        pie: 'Recreación ilustrativa: el recorrido es el del código, los datos son de ejemplo.',
        sitio: 'este mismo sitio',
        verCaso: 'Ir al caso',
        escenariosLabel: 'Escenarios del circuito',
        nodos: {
          internet: 'Tráfico',
          ci: 'Despliegues',
          monitor: 'Monitoreo',
        ...
        lecturas: {
          ...
          alDia: 'al día',
          hitos: 'hito 4 de 6',
          cifrados: 'todo cifrado',
          silencio: 'en silencio',
          operativo: 'operativo',
          flagActivo: '500 · quedan {ttl}',
          caida: '1 caída',
          alertaRecibida: '1 alerta',
          incidente: 'incidente',
          healthFalla: 'health falla',
          runRegistrado: 'run guardado',
          clasificando: 'inspeccionando',
          bloqueada: 'frenada',
          bloqueo1h: 'bloqueo 1 h',
          anomalia: 'anomalía',
          registrando: 'registrando',
          margen: 'recalculado',
          cifrando: 'cifrando',
          hitoNuevo: 'hito nuevo',
          uptime: 'uptime real',
        },
        escenarios: [
          {
            nombre: 'Experimento de caos',
            lineas: [
              'flag activado: HTTP 500 en /tienda, con TTL de {ttl}',
              'sondeo a /tienda: responde 500',
              'incidente abierto: el presupuesto de error empieza a gastarse',
              'alerta en el celular',
              '/status publica el incidente',
              'pánico: todos los flags apagados',
              'sondeo a /tienda: 200, incidente cerrado',
              'la alerta funciona, y ahora hay prueba de ello',
            ],
          },
          {
            nombre: 'Deploy roto',
            lineas: [
              'push a main: tests y build en verde',
              'deploy de v1.5 a producción',
              'health check contra el sitio real: falla',
              'rollback automático a v1.4',
              'health check: 200, el sitio sigue en pie',
              'run guardado en el panel como rollback',
            ],
          },
          {
            nombre: 'Sondeo hostil',
            lineas: [
              'visita normal: pasa limpia',
              'petición a un archivo de configuración',
              'clasificada: búsqueda de secretos',
              'mismo origen, diez por segundo: límite de tasa (429)',
              'frenada antes de llegar a las rutas',
              'cron horario: bloqueo de 1 h, escala a 24 h si reincide',
              'anomalía sobre la línea base: alerta al celular',
            ],
          },
          {
            nombre: 'Proyecto nuevo',
            lineas: [
              'servicio registrado: hosting anual, {mensual} al mes',
              'P&L del proyecto recalculado',
              'la credencial del servicio entra cifrada a la base',
              'hito publicado: visible en el portal del cliente',
              'el portal muestra el uptime real de su sitio',
            ],
          },
        ],
      },
      ventana: {
        etiqueta: 'datos ilustrativos',
        indice: 'Casos',
      },
      monitors: {
        contenido: 'contenido',
      ...
      pnl: {
        ...
        servicios: ['Hosting', 'Dominio .co', 'Base de datos', 'Correo'],
        ciclos: { annual: 'anual', monthly: 'mensual', free: 'gratis' },
        alMes: 'al mes',
        ...
        nota: 'Calculado con las funciones del panel',
      },
      seg: {
        vista: 'Vista',
        panel: 'panel',
        cliente: 'cliente',
        vis: { publico: 'público', cliente: 'cliente', interno: 'interno' },
        items: [
          { d: '02 jul', t: 'Deploy a producción · v1.4' },
          { d: '30 jun', t: 'Nota interna: comparar tarifas de la pasarela' },
          { d: '28 jun', t: 'Briefing aprobado: módulo de pagos' },
          { d: '24 jun', t: 'Reunión de seguimiento · acta enviada' },
        ],
        proximo: { d: 'próx.', t: 'Entrega: integración de facturación' },
        oculto: 'el cliente no la ve',
      },
      boveda: {
        nombre: 'nombre',
        valor: 'valor',
        valorEjemplo: 'ejemplo-no-real',
        guardar: 'guardar',
        enBase: 'lo que queda en la base',
        alterado: 'un byte alterado en la base',
        descifrar: 'descifrar',
        rechazo: 'rechazado: la etiqueta no coincide',
        llave: 'la clave vive en el entorno del servidor, no en la base',
        real: 'Cifrado real en el build, con una clave de un solo uso',
      },
      pipeline: {
        historial: 'historial de runs',
        exito: 'éxito',
        revertido: 'revertido',
        revirtiendo: 'rollback a {sha}',
        enVivo: 'en producción',
      },
      caos: {
        latencia: 'Latencia +2 s',
        peticiones: 'peticiones',
        protegida: 'excluida por código',
        panico: 'Pánico: apagar todo',
        detectado: 'monitor: caída detectada · alerta enviada',
        ttlNota: 'ningún flag dura más de {ttl}',
      },
      security: {
        eventos: ['Búsqueda de secretos', 'Reconocimiento de CMS', 'Inyección (SQLi/XSS)', 'Búsqueda de secretos'],
        linea: 'eventos por hora frente a la línea base de 30 días',
        anomalia: 'anomalía',
        escalera: 'bloqueo por reincidencia',
        nunca: 'nunca eterno',
      },
    },
    demoPortal: {
  ...
  security: {
    ...
    // de las demostraciones (montos, consultas) viven en sus componentes.
    motion: {
      filtro: {
        titulo: 'Filtro en vivo',
        sub: 'reparto real de {days} días',
        capas: [
          { nombre: 'Plataforma', dato: 'fuera de este sitio' },
          { nombre: 'Clasificador', dato: '{n} detectados' },
          { nombre: 'Señuelos', dato: '{n} atrapados' },
          { nombre: 'Cron horario', dato: '{n} bloqueos' },
        ],
        sitio: 'sitio',
        bitacora: 'bitácora',
        tu: 'tú',
        tuLlego: 'Tu visita llegó hasta aquí: ninguna capa la detuvo.',
        ...
        destinos: {
          limpia: 'petición limpia',
          frenada: 'frenada en el clasificador',
          senuelo: 'atrapada por un señuelo',
          registrada: 'registrada en la bitácora',
        },
        otros: 'Otras categorías',
      },
      secopsTitle: 'Lo que llegó este mes, y qué pasó con ello.',
      ...
      demos: {
        webhook: {
          evento: 'evento de pago',
          valido: 'firma válida',
          aplicado: 'aplicado',
          alterado: 'monto alterado en tránsito',
          rechazado: 'rechazado: la firma no coincide',
        },
        boveda: {
          claro: 'en claro, solo en memoria',
          cifrado: 'lo que guarda la base de datos',
          clave: 'la clave vive en el entorno del servidor',
        },
        admin: {
          login: 'inicio de sesión',
          peticion: 'petición',
          revalida: 'allowlist revalidada',
          sinClaim: 'sesión sin login',
          rechazo: 'rechazada',
        },
        sql: {
          entrada: 'lo que escribe el atacante',
          consulta: 'consulta',
          parametro: 'parámetro',
          resultado: '0 filas: la entrada viaja como dato, no como código',
        },
      },
      methodologyTitle: 'Cómo se hizo.',
      pasos: ['Revisar', 'Corregir', 'Publicar'],
    },
  },
  contact: {
  ...
  fpRoom: {
    ...
    description: 'Esto es lo que tu navegador reveló sin que hicieras nada.',
    room: 'Sala',
    gateTitle: 'Antes de empezar',
    gateBody: 'Al continuar, tu navegador va a compartir señales técnicas (canvas, GPU, fuentes, audio, pantalla, comportamiento de mouse/teclado) con el tablero de esta sala, para demostrar cómo funciona el fingerprinting. Nada se guarda tras cerrarse la sala (máx. 2 horas).',
    accept: 'Entiendo, continuar',
    youAre: 'Eres el',
    returningNote: 'Este dispositivo ya había pasado por aquí - reconocido de nuevo sin cookies.',
    revealed: 'Esto es lo que tu navegador reveló, sin que dieras ningún permiso especial:',
    uniqueness: 'Unicidad estimada',
    bits: 'bits',
    oddsPre: '≈ 1 en',
    oddsPost: 'dispositivos con esta misma combinación de señales. Estimación educativa basada en pesos publicados por estudios de fingerprinting (EFF Panopticlick / AmIUnique), no una medición poblacional en vivo.',
    watchBoard: 'Mira el tablero en la pantalla principal - apareces ahí en vivo.',
    collecting: 'Recolectando…',
    retryError: 'Error, intenta de nuevo',
    empty: '(vacío)',
  },
  fpBoard: {
    title: 'Tablero - Laboratorio de Fingerprinting',
    scanToEnter: 'Escanea para entrar',
    devicesInRoom: 'Dispositivos en sala',
