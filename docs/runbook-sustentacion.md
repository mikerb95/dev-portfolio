...
## 2. Cómo obtener el PIN y proyectarlo
...
3. El PIN sale en la respuesta (`pin`) y en la propia pantalla de
   `/sustentacion`. Se proyecta o se dicta en voz alta; el público lo escribe
   en `/sustentacion/seguir/<pin>` desde su celular.
...
## 3. Cómo cambiar a modo respaldo si la red falla
...
## 4. Qué verificar 10 minutos antes de entrar
